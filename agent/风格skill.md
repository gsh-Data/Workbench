...
# Geometric Bold (几何大胆风) Design System
...
### 字体
```
标题: font-black uppercase tracking-tight
...
```html
<button class="font-bold uppercase tracking-widest transition-colors duration-200 bg-[#ff006e] text-white px-4 py-2 md:px-6 md:py-3">
  点击我
</button>
```
...
<div class="border-4 border-black bg-white p-6 md:p-8">
  <h3 class="font-black uppercase tracking-tight text-xl md:text-2xl">标题</h3>
</div>
```
...
```html
<input class="border-4 border-black bg-white font-medium focus:outline-none focus:bg-yellow-300 transition-colors duration-200 px-3 py-2 md:px-4 md:py-3" placeholder="请输入..." />
```
...
生成 几何大胆风风格的 SaaS 产品着陆页

```
Create a SaaS landing page using Geometric Bold style with hero section, feature grid, testimonials, pricing table, and footer.
```
...
```
Create a portfolio showcase page using Geometric Bold style with project grid, about section, contact form, and consistent visual language.
```
